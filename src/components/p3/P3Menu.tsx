...
const ITEMS = [
  ...
  { id: "projects",label: "PROJECTS",      page: "projects",fontSize: 68, offsetX: 10, offsetY: 6,  skew: -4,  skewY: 7   },
];
...
export default function P3Menu({ onNavigate }: { onNavigate?: (page: string) => void }) {
