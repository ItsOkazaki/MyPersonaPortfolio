...
const mainm = "/assets/mainm.jpeg";
const mainm2 = "/assets/mainm2.jpeg";
const mainf = "/assets/mainf.jpeg";
...
const REVEAL_CONTENT = [
  {
    upper: ["Mostapha Rahmani", "Age: 20"],
    lower: "Major: Computer Science",
  },
  {
    upper: [
      "I am an IT department member at Quantum Code club.",
      "A passionate gamer and journalist for El Baraka & Echourok TV.",
      "Expert in Game Localization (معرب العاب) and Millennium Dawn dev.",
    ],
    lower: "Fun Facts About Me",
  },
  {
    upper: [
      "I study at University Center of El Bayadh in Algeria.",
      "Part of the tech community driving innovation.",
      "Always exploring new development horizons.",
    ],
    lower: "Academic & Career Facts",
  },
];

const ROLES = [
  { text: "IDENTITY", color: "#e8c100", bg: "rgba(232,193,0,0.12)", border: "rgba(232,193,0,0.5)" },
  { text: "FACTS",  color: "#4a8fff", bg: "rgba(74,143,255,0.12)", border: "rgba(74,143,255,0.5)" },
  { text: "WIRED",  color: "#4a8fff", bg: "rgba(74,143,255,0.12)", border: "rgba(74,143,255,0.5)" },
];

const ITEMS = [
  {
    id: "about_me", label: "ABOUT ME", handle: "@Mostapha", href: "#", icon: "👤", bars: 1, 
    stats: [
      { tag: "LVL", value: "20", color: "#4a8fff" },
      { tag: "HP", value: "999",  color: "#bf94ff" },
    ],
  },
  {
    id: "fun_facts", label: "FUN FACTS ABOUT ME", handle: "@Mostapha", href: "#", icon: "🎮", bars: 5, 
    stats: [
      { tag: "EXP", value: "MAX", color: "#e1306c" },
      { tag: "SP", value: "128",  color: "#f77737" },
    ],
  },
  {
    id: "wired_facts", label: "WIRED FACTS ABOUT ME", handle: "@Mostapha", href: "#", icon: "⚛️", bars: 7, 
    stats: [
      { tag: "STR", value: "99", color: "#00f2ea" },
      { tag: "INT", value: "99",  color: "#ff0050" },
    ],
  },
];
